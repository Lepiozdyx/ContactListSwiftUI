...
final class DataStore {
    ...
    let names = ["Lewis", "Max", "Valtteri", "Lando", "Sergio", "Daniel", "Charles", "Pierre", "Esteban", "Carlos", "Lance", "Fernando", "Sebastian", "Yuki", "George", "Kimi", "Antonio", "Mick", "Nikita", "Nicholas"]

    let surnames = ["Hamilton", "Verstappen", "Bottas", "Norris", "Perez", "Ricciardo", "Leclerc", "Gasly", "Ocon", "Sainz", "Stroll", "Alonso", "Vettel", "Tsunoda", "Russell", "Raikkonen", "Giovinazzi", "Schumacher", "Mazepin", "Latifi"]
